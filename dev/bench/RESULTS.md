...
The [online AMD EPYC results](online/RESULTS.md) cover the deployed Magento environment, including a reproducible frontend URL and public HTTP measurements.
