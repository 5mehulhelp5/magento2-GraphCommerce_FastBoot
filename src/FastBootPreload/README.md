...
Class preload loads PHP class definitions when PHP-FPM starts. It is independent of [FastBoot's data caches](../FastBoot/README.md): disabling preload keeps FastBoot and regular OPcache available.
